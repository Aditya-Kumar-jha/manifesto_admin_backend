...
ActiveRecord::Schema.define(version: 2022_04_25_105028) do
  ...
  create_table "manifestos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "active", default: true
    t.bigint "language_id"
    t.index ["language_id"], name: "index_manifestos_on_language_id"
  end
  ...
  add_foreign_key "manifestos", "languages"
end
